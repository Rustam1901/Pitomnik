...
klaus@klaus-VirtualBox:\~/Pitomnik$ cat \> Pets.txt
...
klaus@klaus-VirtualBox:\~/Pitomnik$ cat \> PackAnimals.txt
...
klaus@klaus-VirtualBox:\~/Pitomnik$ cat Pets.txt PackAnimals.txt \> Animals.txt

klaus@klaus-VirtualBox:\~/Pitomnik$ cat Animals.txt
...
klaus@klaus-VirtualBox:\~/Pitomnik$ mv Animals.txt HumanFriends.txt

klaus@klaus-VirtualBox:\~/Pitomnik$ ls

HumanFriends.txt  PackAnimals.txt  Pets.txt  
klaus@klaus-VirtualBox:\~/Pitomnik$ mkdir PetsDirectory

klaus@klaus-VirtualBox:\~/Pitomnik$ mv HumanFriends.txt PetsDirectory/

klaus@klaus-VirtualBox:\~/Pitomnik$ cd PetsDirectory/

klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ ls

HumanFriends.txt
```
## 3\. klaus@klaus-VirtualBox:\~/Pitomnik2/PetsDirectory$ sudo apt-get update
```
\[sudo\] пароль для klaus:
...
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ sudo apt-get intstall mysql-server

E: Неверная операция intstall

klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ sudo apt-get install mysql-server
...
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ mysql \--version

mysql  Ver 8.0.39 for Linux on x86\_64 (MySQL Community Server \- GPL)
```
## 4\.
```
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ sudo apt-get install cowsay
...
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ cowsay "Здарова отец\!"
...
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ sudo apt-get remove cowsay
...
## 5\.  
``` 
klaus@klaus-VirtualBox:\~/Pitomnik/PetsDirectory$ history \> history.txt
